...
const Accounts = () => {
  ...
  const handleConnect = async (platformId: string) => {
    ...
    try {
      ...
      toast.error(error?.response?.data?.message || error?.message || `Falied to connect ${platformId}`)
      setConnecting(null);
    }
  };
  ...
  const handleDisconnect = async (accountId: string) => {
    try {
      ...
      toast.error(error?.response?.data?.message || error?.message || "Falied to disconnect account");
    }
  };
