...
const Accounts = () => {
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      {/* Header */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-sm font-inter font-medium">
        <div>
          <h2 className="text-xl text-slate-900">Connected Accounts</h2>
          <span className="text-slate-500 text-sm mt-0.5">{accounts.length} of {PLATFORMS.length} platforms connected</span>
        </div>
      ...
      {showPlatformPicker && <PlatformPickerModal connectedIds={connectIds} connecting={connecting}
