    ...
    return (
        <section className="relative overflow-hidden bg-primary">
            ...
            <div className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-20 pb-12 text-center">
                ...
                {/* Subheadline */}
                <p className="mt-7 text-gray-300 font-inter max-w-2xl mx-auto">Scheduler lets you create, schedule, and auto-engage across all your social platforms — powered by AI that writes your captions and replies for you.</p>

                {/* CTAs */}
                <div className="mt-7 flex flex-col sm:flex-row items-center justify-center gap-3">
                    <Link to="/login" className="bg-red-500 text-white font-inter font-semibold rounded-full font-medium hover:bg-lime-400 hover:text-black hover:shadow-[0_8px_24px_rgba(239,68,68,0.35)] inline-flex items-center gap-2 text-[15px] px-8 py-3.5 w-full sm:w-auto justify-center transition-all">
