    ...
    if(accounts.length === 0){
        return (
            <div className="bg-white rounded-2xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center py-20 px-6">
                ...
                <p className="text-sm text-slate-400 mt-1 max-w-xs text-center">connect your first social platform to start sceduling and automating your content.</p>
            </div>
        )
    }
    return(
                        ...
                        <div className="flex items-center gap-1.5 shrink-0">
                            {account.status === 'connected' ? (
                                ...
                                <>
                                    ...
                                    <span className="text-xs text-emerald-600">Disconnected</span>
                                </>
                            )}
                        </div>
                        <button
